...
USAGE:
    curl -sL https://gitee.com/westinyang/codelabs/raw/master/shell/get-frida-tools-version.sh | bash -s <frida-version> # default: main
    curl -sL https://raw.githubusercontent.com/westinyang/codelabs/master/shell/get-frida-tools-version.sh | bash -s <frida-version> # default: main
